...
class GetCosmoteBoundingBoxMapUsecase
    implements Usecase<BoundingBoxMap, CosmoteDocumentFormat> {
  @override
  Future<BoundingBoxMap> execute(CosmoteDocumentFormat offset) {
    final map = {
      'rfCode': TargetWord(
